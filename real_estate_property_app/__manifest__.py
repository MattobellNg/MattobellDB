...
{
    'name': "Sale of Real Estate Property Management",
    'depends': ['website_sale','sales_team', 'sale','sales_commission_external_user'],
    'currency': 'EUR',
    'license': 'Other proprietary',
    'price': 79.0,
    'summary': """This app allow you to manage property, sale property from website, get quote for property, agent commission.""",
    'description': """
...
""",
    ...
    'images' : ['static/description/rep.jpg'],
    #'live_test_url': 'https://youtu.be/aXyPK01U_hU',
    'live_test_url': 'https://probuseappdemo.com/probuse_apps/real_estate_property_app/11',#'https://youtu.be/hyR__covUtg',
    'data':[
        'security/ir.model.access.csv',
        'data/product_property_type_data.xml',
